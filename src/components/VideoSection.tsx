    ...
    <section className="section-dark py-16">
      <div className="container">
        <div className="max-w-lg mx-auto">
          <div className="relative pb-[56.25%] h-0 rounded-lg overflow-hidden shadow-2xl">
            <iframe
              ...
              src="https://www.youtube.com/embed/dBAytgCCuPs?rel=0"
        ...
        <h2 className="font-heading text-2xl md:text-3xl text-center mt-16 mb-4">
          ...
          <strong className="text-highlight">Curso Venda com Propósito</strong>
        ...
        <p className="text-cream text-center max-w-2xl mx-auto text-base md:text-lg mb-10">
          ...
          <strong className="text-highlight">trava na hora de vender</strong>. Se você quer crescer com integridade, sem perder sua essência, esse Curso é para você.
        </p>
